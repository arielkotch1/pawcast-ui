...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "80°F air can still mean burning sidewalks. Learn what 80 degrees actually means for paws.",
    url: pageUrl,
    siteName: "PawsOut",
    type: "article",
    images: [ogImage],
    ...
    <div className="min-h-screen bg-transparent">
      ...
      <article className="pt-28 md:pt-32 pb-20 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
          It can be. 80°F is about 27°C in the air. That number is what the forecast shows. Your dog
          walks on the ground, and in direct sun that ground is often much hotter — especially dark
          asphalt.
        </p>

        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          80°F air is not 80°F pavement
        </h2>
        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          On a clear afternoon, asphalt can sit 20–30°C above the air. An 80°F day can mean
          sidewalks hot enough to burn pads even if you feel fine in shoes. Shaded grass at the same
          air temperature is a different walk. That is the whole point of the{" "}
          <Link
        ...
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
          ...
          on an 80°F day makes panting less effective too. This guide is educational, not a
          diagnosis.
        </p>

        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          Check the hour, not just 80°
        </h2>
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
