...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "Frenchies, Pugs, and other flat-faced dogs need a tighter walk window in hot weather.",
    url: pageUrl,
    siteName: "PawsOut",
    type: "article",
    images: [ogImage],
    ...
    <div className="min-h-screen bg-transparent">
      ...
      <article className="pt-28 md:pt-32 pb-20 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
          ...
          than a Lab on the same sidewalk. Their shorter muzzle leaves less airway for panting,
          which is how dogs dump heat. The same 28°C walk that is merely warm for a longer-nosed dog
          can be dangerous for them.
        </p>

        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          What &quot;brachycephalic&quot; changes
        </h2>
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          Safer heat walks for flat-faced dogs
        </h2>
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
