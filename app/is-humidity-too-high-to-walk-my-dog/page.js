...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "A mild temperature can still be unsafe when the air is wet. Learn why humidity changes dog walks.",
    url: pageUrl,
    siteName: "PawsOut",
    type: "article",
    images: [ogImage],
    ...
    <div className="min-h-screen bg-transparent">
      ...
      <article className="pt-28 md:pt-32 pb-20 px-6 md:px-12 max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
          It can be — even when the temperature looks mild. Dogs cool mainly by panting. When the
          air is already wet, that cooling slows down, so body temperature climbs faster than a dry
          day at the same number on the forecast.
        </p>

        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          Why humidity hits dogs harder
        </h2>
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          What to do on a humid day
        </h2>
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
          Walk earlier or later, keep the loop short, stay in shade, and carry water. Stop if
          panting gets heavy, the tongue looks wide and floppy, or your dog slows down or lies down.
          This guide is educational. If you are worried, contact a veterinarian.
        </p>

        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          Let PawsOut time the window
        </h2>
        <p className="text-lg text-gray-700 mb-10 leading-relaxed">
